...
const renderOffscreenToCanvas = (debugCanvasRef, bitmap, width, height, visible) => {
...
const Particles = /*#__PURE__*/forwardRef(({
  debugCanvasRef,
  width,
  height,
  options
  ...
  useImperativeHandle(ref, () => ({
    setImage: image => setImages(state => {
  ...
  return /*#__PURE__*/_jsx(_Fragment, {
    children: data && /*#__PURE__*/_jsxs("mesh", {
      "rotation-y": Math.PI,
